...
Phase 3 demonstrates the integration of **Azure PromptOrchestrator** (from Phase 2) with **ROS2** and **Gazebo**, enabling **LLM-driven multi-step construction task planning** using **Chain-of-Thought reasoning**.  
...
- 🤖 Controls **2 construction robots** (ground & upper floor)  
